...
- Created new patches for almost all Famicom Mini series titles, except those already done (Vols. 11, 17, 18, 21) and a few odd ones which enable sleep from ARM code running in VRAM rather than directly executing Thumb instructions from ROM (Vols. 04, 05, 09, 10).
